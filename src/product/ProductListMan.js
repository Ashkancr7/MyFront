...
const ProductListMan = () => {
    ...
    useEffect(() => {
        axios.get('https://mystore-pbfe.onrender.com/api/products/category/مردانه')
          .then(res => {
        ...
        <div className="w-full bg-gray-100 flex flex-col items-center">
            <div className="w-full   px-4 py-10">
                <div className='flex flex-row align-center justify-center'>
                    ...
                    <h2 className="text-sm  sm:text-base md:text-2xl font-semibold mb-6 text-center">محصولات مردانه</h2>
                ...
                <div className="w-full max-w-[1] overflow-x-auto custom-scrollbar">
                    <div className="flex gap-6 w-max">
                        ...
                        <button onClick={() => navigate('/ManProducts')} className='flex align-center justify-center items-center  h-12 w-32 mt-32 rounded hover:bg-gray-300  '>
