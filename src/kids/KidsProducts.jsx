    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const response = await axios.get('https://mystore-pbfe.onrender.com/api/products/category/بچگانه');
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white shadow-sm sticky top-0 z-10">
                ...
                <div className="container mx-auto px-4 py-4">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-800">محصولات بچگانه</h1>
                    <nav className="flex items-center mt-2 text-sm text-gray-600">
                        <a href="/" className="hover:text-blue-600">خانه</a>
                        <span className="mx-2">/</span>
                        <span className="text-blue-600">بچگانه</span>
                    </nav>
                </div>
            </header>
