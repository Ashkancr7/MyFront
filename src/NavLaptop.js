...
const NavLaptop = () => { 
  ...
  const programering = ["وب", "اندروید", "PWA", ".NET", "فرانت اند", "بک اند",];
  const games = ["FC26", "FC25", "PES", "GTA V", "CAR",];
      ...
      <div className="w-full max-w-full mx-auto px-4">
        ...
        <div className="hidden md:grid grid-cols-2 items-center w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="" className="hover:text-gray-900  lg:text-sm">محصولات</a>
            <DropdownMenu categories={programering} title="برنامه نویسی" />
            <DropdownMenu categories={games} title="بازی" />
            <a href="" className="hover:text-gray-900">HP</a>
            <a href="" className="hover:text-gray-900  lg:text-sm">ACER</a>
            <a href="" className="hover:text-gray-900  lg:text-sm">MSI</a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 bg-white border-t border-gray-200">
            <div className="px-2 pt-2 pb-4 space-y-2">
              ...
              <a href="/" className="block px-3 py-2 hover:bg-gray-100 rounded">محصولات</a>
